 ...
 * @author DELL
 */
public class TalentDetailControl extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<Feedback> listF = dao.getListFeedbackByTalentId(tid);
        int numberFeedback = dao.getNumberFeedbackByTalentId(tid);
