 ...
 * @author tuna
 */
@WebServlet(name = "DetailTalentServlet", urlPatterns = {"/detailTalentServlet"})
public class DetailTalentServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DetailTalentServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet DetailTalentServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
...
//        System.out.println(talentIDParam);
        ...
        request.getSession().setAttribute("talentChoiced", t);

        AccountDAO ad = new AccountDAO();
        Account a = ad.getAccountById(t.getAccountID());
        System.out.println(a);
        request.getSession().setAttribute("accountTalent", a);
