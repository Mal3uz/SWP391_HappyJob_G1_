...
public class BlogController {
    ...
    )// config de servlet nhan upload file
    public static class CreateBlog extends HttpServlet{
        public static String generateUniqueFileName(String originalFileName) {// tao ten file k trung lap
            String extension = "";
        ...
        public static String getFileName(Part part) { // lay file name tu Part
