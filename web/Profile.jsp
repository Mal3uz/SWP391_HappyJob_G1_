<%-- 
    Document   : Profile
    Created on : Jan 16, 2024, 6:05:41 PM
    Author     : DELL
--%>
                    ...
                    <div class="card mb-3">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"> Pham Nam Phuong</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary"> phuongnampham7823@gmail.com
                                </div></div><hr><div class="row">
                                <div class="col-sm-3">
                                    <h6 class="mb-0">Phone</h6>
                                </div>
                                <div class="col-sm-9 text-secondary"> 076 xxx xxxx</div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">Da Nang, Viet Nam</div>
