        ...
        <div class="row mb-5">
            <% for (int i = 0; i < blogs.size(); i++) { %>
                <div class="col-md-6 col-lg-4 mb-5">
                    <a href="<%=request.getContextPath()%>/view-blog?id=<%=blogs.get(i).BlogID%>"><img src="<%=request.getContextPath()%>/<%=blogs.get(i).thumbnail%>" style="width: 100%; height: 75%; object-fit: cover;" alt="Image" class="img-fluid rounded mb-4"></a>
